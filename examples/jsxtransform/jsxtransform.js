...
var ExampleStage = React.createClass({
  ...
  render: function() {
    ...
    return React.createElement(Stage, {width: this.props.width, height: this.props.height}, 
      React.createElement(TilingSprite, {image: assetpath('bg_castle.png'), width: this.props.width, height: this.props.height, key: "1"}), 
      React.createElement(Text, {text: "Vector text", x: this.props.xposition, y: 10, style: fontstyle, anchor: new PIXI.Point(0.5,0), key: "2"})
    );
  }
});
...
function jsxtransformstart() {
    ...
    function PutReact()
    {
      var stageElement = React.createElement(ExampleStage, {width: 600, height: 400, xposition: 200, topping: "vanilla"});
